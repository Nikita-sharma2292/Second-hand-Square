                ...
                <form onSubmit={handleSubmit(submit)}>
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-6 gap-6">
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="Fuel" className="text-sm font-medium text-gray-900 block mb-2">Fuel</label>
                                <select
                                    name="Fuel"
                                    className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    {...register('Fuel', {
                                        required: { value: true, message: "Fuel is required" },
                                    })}
                                >
                                    <option value=""></option>
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="Transmission" className="text-sm font-medium text-gray-900 block mb-2">Transmission</label>
                                <select
                                    name="Transmission"
                                    className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    {...register('Transmission', {
                                        required: { value: true, message: "Transmission is required" },
                                    })}
                                >
                                    <option value=""></option>
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="NoOfOwners" className="text-sm font-medium text-gray-900 block mb-2">No. of owners</label>
                                <select
                                    name="NoOfOwners"
                                    className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    {...register('NoOfOwners', {
                                        required: { value: true, message: "No Of Owners is required" },
                                    })}
                                >
                                    <option value=""></option>
                                ...
                                {errors.NoOfOwners && (
                                    <p className="text-red-500 text-sm mt-1">{errors.NoOfOwners.message}</p>
                                )}
                            </div>
                            <div className="col-span-6 sm:col-span-3">
