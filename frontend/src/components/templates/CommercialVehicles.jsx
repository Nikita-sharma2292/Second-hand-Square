...
function CommercialVehicals() {
    ...
    const handleApi = () => {
        ...
        formData.append('Category', 'Commercial Vehicals')
        formData.append('SubCategory', 'Commercial and Other Vehicles')
        
        const url = "http://localhost:4000/addProduct/CommercialVehicals/Commercial and Other Vehicles";
...
export default CommercialVehicals;