...
function Mobiles() {
    ...
    const handleApi = () => {
        ...
        formData.append('Category', 'Mobiles')
        formData.append('SubCategory', 'Mobile Phones')

        const url = "http://localhost:4000/addProduct/Mobiles/Mobile%20Phones";
                    ...
                    <form action="#">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select id="Brand" value={Brand} class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" onChange={(e) => { setBrand(e.target.value) }}>
                                    <option selected>Some Popular brands</option>
