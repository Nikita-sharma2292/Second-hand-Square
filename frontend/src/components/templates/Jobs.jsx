                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-6 gap-6">
                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="SalaryPeriod" className="text-sm font-medium text-gray-900 block mb-2">Salary Period</label>
                                <select
                                    name="SalaryPeriod"
                                    className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    {...register('SalaryPeriod', {
                                        required: { value: true, message: "Salary Period is required" },
                                    })}
                                >
                                    <option value=""></option>
                                ...
                                {errors.SalaryPeriod && (
                                    <p className="text-red-500 text-sm mt-1">{errors.SalaryPeriod.message}</p>
                                )}
                            </div>
                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="Position" className="text-sm font-medium text-gray-900 block mb-2">Position Type</label>
                                <select
                                    name="Position"
                                    className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    {...register('Position', {
                                        required: { value: true, message: "Position Type is required" },
                                    })}
                                >
                                    <option value=""></option>
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="SalaryFrom" className="text-sm font-medium text-gray-900 block mb-2">Salary From</label>
                                <input
                                    type="text"
                                    name="SalaryFrom"
                                    className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    placeholder="Enter Salary starting date:"
                                    {...register('SalaryFrom', {
                                        required: { value: true, message: "Salary From is required" },
                                    })}
                                />
                                {errors.SalaryFrom && (
                                    <p className="text-red-500 text-sm mt-1">{errors.SalaryFrom.message}</p>
                                )}
                            </div>

                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="SalaryTo" className="text-sm font-medium text-gray-900 block mb-2">Salary To</label>
                                <input
                                    type="text"
                                    name="SalaryTo"
                                    className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                    placeholder="Enter Salary ending date:"
                                    {...register('SalaryTo', {
                                        required: { value: true, message: "Salary To is required" },
                                    })}
                                />
                                {errors.SalaryTo && (
                                    <p className="text-red-500 text-sm mt-1">{errors.SalaryTo.message}</p>
                                )}
                            </div>
